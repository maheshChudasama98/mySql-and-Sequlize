...
import RolesUpdata from './RolesUpdata'
    ...
    return (
        <>
            <div className='container mt-5'>
                ...
                {open && <RolesAdd modalcallbak={modalcallbak} datapass={datapass} getUseApi={getUseApi} />}
                {openModal && <RolesUpdata modalcallbakModel={modalcallbakModel} datapass={datapass} getUseApi={getUseApi} />}
            </div>
