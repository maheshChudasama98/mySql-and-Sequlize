...
function UserUpdateModal(props) {
    console.log(props.pass.Company.Company_Name);
    useEffect(() => {
        RolesFun()
        DesignationFun()
        CompanyFun()
    ...
    const [dataset, setDataset] = useState( props.pass.Designation.Desi_Name)
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            axios.put(`http://localhost:8080/sequlize/User/${props.pass.User_id}`, data).then((response) => {
